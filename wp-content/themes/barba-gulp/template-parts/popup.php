    ...
    <div class="row">
      <div class="col-12">
        <div class="page-popup__wrap">
          ...
          <p class="page-popup__information">Podpisując nasz apel sprzeciwiasz się nadużyciom, które negatywnie wpływają na
            wizerunek branży PR. Bo PR to nie propaganda! </p>
          <form class="page-popup__form">
            <input type="text" placeholder="Imię i nazwisko" class="page-popup__input">
            <input type="email" placeholder="E-mail" class="page-popup__input">
            ...
            <div class="page-popup__check-wrap d-flex">
              ...
              <span class="page-popup__checkmark"></span>
              <label for="data" class="page-popup__label">Wyrażam zgodę na przetwarzanie podanych przeze mnie w formularzu
                danych osobowych przez administratora danych osobowych, którym jest Związek Firm Public Relations z
                siedzibą w Warszawie 00-732, przy ul. Czerskiej 8/10 („ZFPR”) w celu podpisania „Apelu” *</label>
            </div>
            <div class="page-popup__check-wrap d-flex">
              <input type="checkbox" name="public" id="" class="page-popup__check">
              <span class="page-popup__checkmark"></span>
              <label for="public" class="page-popup__label">Wyrażam zgodę na publikację przez Związek Firm Public Relations
                mojego imienia i nazwiska na stronie internetowej www.prtoniepropaganda.pl (zgoda jest dobrowolna, ale
